...
% Part B4: Closed FWH1
% Extraction steam
CFWH_extractT = 72.22;                                                        % Temperature at extration steam inlet, in deg C (CHANGE THIS LINE TO IVANPAH FWH NO.5)
CFWH_extractP = 0.3429;                                                         % Pressure at extration steam inlet, in bar (CHANGE THIS LINE TO IVANPAH FWH NO.5)
% Feedwater
CFWH_feedwaterInT = 46.68;                                                    % Temperature at feedwater(main flow) inlet, in deg C (CHANGE THIS LINE TO IVANPAH FWH NO.5)
CFWH_feedwaterInP =15.43;                                                    % Pressure at feedwater(main flow) inlet, in bar (CHANGE THIS LINE TO IVANPAH FWH NO.5)
...
CFWH_drainInM = 35.77;                                                         % Mass flow rate at drain inlet, in tons/hr (CHANGE THIS LINE TO IVANPAH FWH NO.5)
CFWH_drainPRatio = 0.3429/2.019;                                                     % Pressure ratio of drain ( outlet / inlet ) (CHANGE THIS LINE TO IVANPAH FWH NO.5)
% Parameter
CFWH_TTD =2.78;                                                               % Terminal temperature difference, in deg C (CHANGE THIS LINE TO IVANPAH FWH NO.5)
