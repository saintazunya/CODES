...
hHV=141800;
%% efficiency
effl(mixT-297)=(Greact-Gprod)/(mf*HV);
effh(mixT-297)=(Greact-Gprod)/(mf*hHV);
...
for mixT=([80 220 650 800]+273.15)
    figurecount=1+figurecount;
    count=0;
    for pstd= [1:5:400,400]
        count=count+1;
plength=length([1:5:400,400]);
Tg=mixT;
mf=1*fuelmolar;
ma=AF*mf;
ph2=pstd;
...
%% plot for second section
 plot([1:5:400,400],effl2{1},'r')
 hold on
 plot([1:5:400,400],effl2{2},'g')
 plot([1:5:400,400],effl2{3},'b')
 plot([1:5:400,400],effl2{4},'k')
 legend('T=80 .C','T=220 .C','T=650 .C','T=800 .C');
 xlabel('Pressure (Bar)');
 ylabel('Efficiency');
 axis([0 4 0.6 1]);
