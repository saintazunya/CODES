...
%% plot 
figure(1)
plot([s2,s23,s25,s3,s41,s46,s48,s50,s2],[h2,h23,h25,h3,h41,h46,h48,h50,h2],'--');
...
figure(2)
plot([v2,v23,v25,v3,v41,v46,v48,v50,v2],[P2,P23,P25,P3,P41,P46,P48,P50,P2],'--');
figure(3)
plot([s2,s23,s25,s3,s41,s46,s48,s50,s2],[T2,T23,T25,T3,T41,T46,T48,T50,T2],'--');
%2)polt prepartion--------------------------------------------------
%{
%% ts diagram
figure(1)
