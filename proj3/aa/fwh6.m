...
% Part B4: Closed FWH6
% Extraction steam
CFWH_extractT = 353.5;                                                        % Temperature at extration steam inlet, in deg C (CHANGE THIS LINE TO IVANPAH FWH NO.5)
CFWH_extractP = 34.93;                                                         % Pressure at extration steam inlet, in bar (CHANGE THIS LINE TO IVANPAH FWH NO.5)
% Feedwater
CFWH_feedwaterInT = 218.2;                                                    % Temperature at feedwater(main flow) inlet, in deg C (CHANGE THIS LINE TO IVANPAH FWH NO.5)
CFWH_feedwaterInP =218.54;                                                    % Pressure at feedwater(main flow) inlet, in bar (CHANGE THIS LINE TO IVANPAH FWH NO.5)
CFWH_feedwaterPRatio = 0.906;                                                 % Pressure ratio of feedwater ( outlet / inlet ) (CHANGE THIS LINE TO IVANPAH FWH NO.5)
CFWH_feedwaterInM = 341.4;                                                    % Mass flow rate in feedwater(main flow), in tons/hr (CHANGE THIS LINE TO IVANPAH FWH NO.5)
% Drain
...
CFWH_drainPRatio =34.93/34.93;                                                     % Pressure ratio of drain ( outlet / inlet ) (CHANGE THIS LINE TO IVANPAH FWH NO.5)
% Parameter
CFWH_TTD =-1.00;                                                               % Terminal temperature difference, in deg C (CHANGE THIS LINE TO IVANPAH FWH NO.5)
