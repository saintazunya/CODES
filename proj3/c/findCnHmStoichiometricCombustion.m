...
%% normal gas
    prodStoich(1,4)=n+airStoich*airMoleFrac(4);
    prodStoich(1,1)=0;
    prodStoich(1,2)=airStoich*airMoleFrac(2);
    prodStoich(1,5)=m/2+airStoich*airMoleFrac(5);
    prodStoich(1,3)=airStoich*airMoleFrac(3);
    prodStoich(1,6)=0;
    prodStoich(1,7)=0;
    prodStoich(1,8)=0;
prod=air;
